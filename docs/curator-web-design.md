...
Routes: / landing, /login wallet (SIWE) or email/password, /demo explicitly labelled fixture snapshot, /app screener and watchlist, /app/positions, /app/leaderboard, /app/settings. Pool detail is a responsive panel. Agent, Telegram and backtesting retain existing CLI support.
